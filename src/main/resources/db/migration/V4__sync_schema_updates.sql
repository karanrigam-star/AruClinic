...
ALTER TABLE doctors ALTER COLUMN user_id BIGINT NULL;
ALTER TABLE patients ALTER COLUMN user_id BIGINT NULL;
ALTER TABLE receptionists ALTER COLUMN user_id BIGINT NULL;
...
ALTER TABLE prescription_items ADD COLUMN IF NOT EXISTS updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP;

ALTER TABLE otp_verifications ADD COLUMN IF NOT EXISTS attempts INT DEFAULT 0;
